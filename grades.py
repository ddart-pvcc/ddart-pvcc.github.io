...
stu= [{'name' : "Anderson, Manuel", 'hw' : 89, 'mid_exam' : 92, 'fin_exam' : 94, 'fin_grade' : 0, 'ltr_grade' : "X",}, 
      {'name' : "Thompson, Yani", 'hw' : 63, 'mid_exam' : 74, 'fin_exam' : 59, 'fin_grade' : 0, 'ltr_grade' : "X",}, 
      {'name' : "Ortiz, Graciela", 'hw' : 81, 'mid_exam' : 76, 'fin_exam' : 79, 'fin_grade' : 0, 'ltr_grade' : "X",},
      {'name' : "Wilson, Danielle", 'hw' : 100, 'mid_exam' : 89, 'fin_exam' : 94, 'fin_grade' : 0, 'ltr_grade' : "X",}]
